...
Note: In order for the main file to compile, you are provided with [this static library](https://s3.amazonaws.com/intranet-projects-files/interviews/484/libavl.a 'this static library'). This library won’t be used during correction, its only purpose is for testing.
